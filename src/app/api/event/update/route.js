...
export async function POST(request) {
  try {
    ...
    if (body.docHeadingColor !== undefined)   data.docHeadingColor = body.docHeadingColor || null;
    if (body.docBodyColor !== undefined)      data.docBodyColor = body.docBodyColor || null;
